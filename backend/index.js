...
const { mongooseConnection } = require("./startuproots/moongoseConnection");
...
app.use(
  cors({
    origin: "http://localhost:3001",//* sondaki slash olmayacak. sadece localhost:3000 e izin ver. Host adresi
